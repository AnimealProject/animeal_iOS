...
public final class StyleTypography {
    ...
    public func bold(_ size: CGFloat) -> StyleFont {
        UIFont(name: preset.bold, size: size) ?? UIFont.systemFont(ofSize: size, weight: .bold)
    }
    ...
    public func medium(_ size: CGFloat) -> StyleFont {
        UIFont(name: preset.medium, size: size) ?? UIFont.systemFont(ofSize: size, weight: .medium)
    }
    ...
    public func semibold(_ size: CGFloat) -> StyleFont {
        UIFont(name: preset.semibold, size: size) ?? UIFont.systemFont(ofSize: size, weight: .semibold)
    }
    ...
    public func regular(_ size: CGFloat) -> StyleFont {
        UIFont(name: preset.regular, size: size) ?? UIFont.systemFont(ofSize: size, weight: .regular)
    }
    ...
    public func light(_ size: CGFloat) -> StyleFont {
        UIFont(name: preset.light, size: size) ?? UIFont.systemFont(ofSize: size, weight: .light)
    }
}
