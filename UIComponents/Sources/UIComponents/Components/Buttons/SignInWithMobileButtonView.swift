//
//  SignInWithMobileButtonView.swift
//  UIComponents
//
...
public final class SignInWithMobileButtonView: UIView, ButtonView {
    // MARK: - Constants
    ...
    private func setup() {
        ...
        button.backgroundColor = UIColor(red: 3.0 / 255.0, green: 191.0 / 255.0, blue: 215.0 / 255.0, alpha: 1.0)
