...
public struct AuthenticationUserAttribute {
    public let key: AuthenticationUserAttributeKey
    public let value: String

    public init(_ key: AuthenticationUserAttributeKey, value: String) {
        self.key = key
        self.value = value
    }
}
...
public enum AuthenticationUserAttributeKey {
...
extension AuthenticationUserAttributeKey: Hashable {}
