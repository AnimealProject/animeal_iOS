...
final class AboutViewController: UIViewController, AboutViewable, ScreenAccessible {
    static var screenIdentifier: String { AboutViewModel.AccessibilityID.screen }
    // MARK: - UI properties
