...
final class FavouriteDetailsViewController: UIViewController, FeedingPointDetailsViewable {
    ...
    private let favouriteDetailsView = FeedingPointDetailsView()
